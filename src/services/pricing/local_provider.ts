...
const FALLBACK_UPDATED_AT = "2026-07-19T00:00:00.000Z";
...
const FALLBACK_MODELS: ModelPricing[] = [
  ...
  { model: "gpt-5.5", modelAlias: "gpt-5.5", inputPerMillion: 5, cachedInputPerMillion: 0.5, outputPerMillion: 30, source: "local", updatedAt: FALLBACK_UPDATED_AT },
